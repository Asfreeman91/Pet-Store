...
public class PetStoreController {
	...
	public PetStoreEmployee addEmployee(@PathVariable Long petStoreId, @RequestBody PetStoreEmployee petStoreEmployee) {
		...
		log.info("Adding an employee {} with ID={}", petStoreEmployee, petStoreId);
	...
	public PetStoreData retrieveAPetStoreById(@PathVariable Long petStoreId) {
	...
	public Map<String,String> deletePetStoreById(@PathVariable Long petStoreId) {
		...
		return Map.of("message", "Pet store with the ID=" + petStoreId + " has been deleted.");
